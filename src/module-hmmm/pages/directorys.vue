<template>
  <div class="container">
    <thehead :text="text" :dialogVisible.sync="dialogVisible" @searchcipline="getDirectorylisting"></thehead>
    <subjectform @btnswitch="btnswitch" :text="text" :list="list" @open="open" @isvisible="isvisible"></subjectform>
    ...
    <!-- 修改 -->
     <el-dialog title="提示" :visible.sync="isVisible" width="40%">
      <el-form label-width="80px" :model="directorythelabel" :rules="directorysrules">
